...
namespace ANARIS.BLL.Helpers
{
    public static class ExtensionMethods
    {
        ...
        public static string InsertVariable(this XmlNode node, ProjectToSave save)
        {
        ...
        public static string InsertListVariable(this XmlNode node, ProjectToSave save)
        {
            string nodeText = string.Empty;
